...
// 타이머 시간을 조정하고 싶으면 아래 변수의 값을 변경하세요.
unsigned long timer = 1 * 15 * 1000UL;                   // 먹이 공급 타이머의 시간
...
{
  now = millis();                                        // 현재 시간 저장
  if(now - last_feeding < timer) return;
...
//==========================================================================================
{
  ...
  oled.setLine(3, "motor: " + motor_state);              // 3번째 줄에 모터 상태
  oled.setLine(4, "time: " + time_remaining);            // 4번째 줄에 타이머 남은 시간
